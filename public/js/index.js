...
let main = document.querySelector('.main-active'); //template the header, footer and main-inactive sections
...
copyright.innerHTML = `Copyright &copy; ${year} Vector Training Academy. All Rights Reserved.`; //toggle active of hamburger
