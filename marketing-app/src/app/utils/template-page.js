...
export default function templatePage () {
	...
	mainInactive.innerHTML = `<div class=\"main-inactive-menu\"><a href=\"./howitworks\"><h3>How it works</h3></a><a href=\"./timeline\"><h3>Application Timeline</h3></a><a href=\"./faqs\"><h3>FAQs</h3></a><hr><h3 id=\"employer-login-mobile\"><a href="https://hire.vectoracademy.io">Employer Login</a></h3><h3 id=\"student-login-mobile\"><a href="https://apply.vectoracademy.io">Student Login</a></h3><h3><button class=\"student-register-mobile\">Apply</button></h3></div><div class=\"employer-modal-mobile hidden\"><div id='form-container' class=\"login-form-container\"><h2>Employer Login</h2><form><input data-type=\"text\" autocomplete=\"email\" class=\"form-full-width\" name=\"institutionID\" maxlength=\"50\" placeholder=\"Institution ID\" required><input type=\"password\" autocomplete=\"current-password\" class=\"form-full-width\" name=\"password\" maxlength=\"50\" placeholder=\"Password\" required><div class='form-submit-button-container'><button>Login</button>	</div></form><p>Don't have an account?&nbsp;&nbsp;&nbsp;<a href=\"./contact\"><u>Contact us!</u></a></p></div></div><div class=\"student-login-modal-mobile hidden\"><div id='form-container' class=\"login-form-container student-login-form-container\"><h2>Student Login</h2><form><input data-type=\"text\" autocomplete=\"email\" class=\"form-full-width\" name=\"email\" maxlength=\"50\" placeholder=\"E-mail\" required><input type=\"password\" autocomplete=\"current-password\" class=\"form-full-width\" name=\"password\" maxlength=\"50\" placeholder=\"Password\" required> 	<div class='form-submit-button-container'><button>Login</button>	</div></form><p>Don't have an account?&nbsp;&nbsp;&nbsp;<u>Sign up here!</u></p></div></div><div class=\"student-register-modal-mobile hidden\"><div id='form-container' class=\"student-register-form-container login-form-container\"><h2>Register</h2><form id='register-form-mobile'><input data-type=\"text\" type=\"e-mail\" class=\"form-full-width\" name=\"email\" maxlength=\"50\" placeholder=\"E-mail\" required><input type=\"password\" autocomplete=\"current-password\" class=\"form-full-width\" name=\"password\" maxlength=\"50\" placeholder=\"Password\" required><input type=\"password\" autocomplete=\"current-password\" class=\"form-full-width\" name=\"password2\" maxlength=\"50\" placeholder=\"Confirm Password\" required><div class='form-submit-button-container'><button >Register</button></div></form><p>Already have an account?&nbsp;&nbsp;&nbsp;<a href="https://apply.vectoracademy.io"><u>Sign in here!</u></a></p></div></div>`;
	document.body.appendChild(mainInactive);
	const footer = document.createElement('footer');
	footer.innerHTML = `<div class='footer-container'><h1><a href=\"./\">Engineering Apprenticeship in the US.</a></h1><div class='footer-contents-container'><div><h3>About</h3><ul><li><a href=\"./privacy\">Privacy Policy</a></li><li><a href=\"./contact\">Contact</a></li></ul></div><div><h3>Social</h3><ul><li><a href=\"https://www.twitter.com/VectorAcad\" target=\"_blank\">Twitter</a></li><li><a href=\"https://www.facebook.com/vectoracademy.io/\" target=\"_blank\">Facebook</a></li><li><a href=\"https://www.reddit.com/r/vectoracademy/\" target=\"_blank\">Reddit</a></li><li><a href=\"https://www.instagram.com/vectoracad/\" target=\"_blank\">Instagram</a></li><li><a href=\"https://www.linkedin.com/company/37268628/\" target=\"_blank\">LinkedIn</a></li></ul></div><div><h3>Resources</h3><ul><li><a href=\"./faqs\">FAQ</a></li><li><a href=\"./howitworks\">How it works</a></li><li class=\"footer-student-register\">Application</li></ul></div></div></div><p></p>`;
	...
	copyright.innerHTML = "Copyright &copy; ".concat(year, " Vector Academy. All Rights Reserved."); 
